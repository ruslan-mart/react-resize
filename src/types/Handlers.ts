...
export type ResizeEndEventHandler = ResizeBaseEventHandler<ResizeEventOptions, void>;
export type ResizeEventHandler = ResizeBaseEventHandler<
  ResizeEventOptions,
  ResizeEventHandlerValues | false | void
>;
export type ResizeMaxEventHandler = ResizeBaseEventHandler<ResizeEventOptionsWithAxis, void>;
export type ResizeMinEventHandler = ResizeBaseEventHandler<ResizeEventOptionsWithAxis, void>;
export type ResizeStartEventHandler = ResizeBaseEventHandler<ResizeEventOptions, false | void>;
